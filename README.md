...
```html
<script type="module">
  import { S3Client } from "https://cdn.jsdelivr.net/gh/aws-sdk/client-s3@3.858.0/index.min.mjs";
...
// Specific
https://cdn.jsdelivr.net/gh/aws-sdk/client-s3@3.858.0/index.min.mjs
```
